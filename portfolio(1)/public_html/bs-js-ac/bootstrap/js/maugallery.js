(function($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    showItemTags(gallery, position, tags) {
      var tagItems =
        '<li class="nav-item"><a class="nav-link active active-tag" href="javascript:void(0)" data-images-toggle="all">all</a></li>';
      $.each(tags, function(index, value) {
        tagItems += `<li class="nav-item active">
                <a class="nav-link" href="javascript:void(0)" data-images-toggle="${value}">${value}</a></li>`;
      });
